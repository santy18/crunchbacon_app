...
export default function LandingPage() {
  return (
    <div className="font-sans bg-bacon-bg text-white overflow-x-hidden min-h-screen">

      {/* Navigation */}
      <nav className="flex justify-between items-center p-6 max-w-7xl mx-auto">
        <div className="flex items-center space-x-2">
          <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-bacon-pink">
            <span className="text-2xl">{'\uD83E\uDD53'}</span>
          </div>
          <span className="text-2xl font-black tracking-tighter font-heading">
            Crunch<span className="text-bacon-pink">Bacon</span>
          </span>
        </div>
        ...
        <Link
          to="/app"
          className="px-6 py-2 rounded-full font-bold transition bg-white text-black no-underline hover:bg-gray-200"
        >
          Open App
        </Link>
      </nav>
      ...
      <header className="relative pt-16 pb-24 px-6 text-center max-w-5xl mx-auto">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-64 opacity-10 blur-[100px] bg-bacon-pink" />
        <h1 className="text-5xl md:text-8xl font-black leading-tight mb-6 font-heading">
          Ditch the Mic. <br />
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Link
            to="/app"
            className="text-white px-10 py-5 rounded-2xl font-black text-xl uppercase tracking-wider bg-bacon-pink no-underline transition-all hover:shadow-[0_0_20px_rgba(255,30,86,0.4)] hover:-translate-y-0.5"
          >
            Start Crunching Free
          </Link>
          <button className="bg-transparent border-2 border-gray-700 text-white px-10 py-5 rounded-2xl font-bold text-xl hover:border-gray-500 transition cursor-pointer">
            Watch Demo
          </button>
        </div>
          ...
          <div className="rounded-3xl border-4 border-neutral-800 overflow-hidden shadow-2xl bg-neutral-900">
            ...
            <div className="flex flex-col md:flex-row h-96">
              <div className="w-full md:w-1/3 bg-neutral-900 border-r border-neutral-800 p-6 text-left">
                <div className="text-xs uppercase font-bold mb-4 tracking-widest text-bacon-pink">Script Editor</div>
              ...
              <div className="flex-1 bg-black flex items-center justify-center relative group">
                ...
                <div className="absolute bottom-4 right-4 text-white text-xs px-2 py-1 rounded font-bold animate-pulse bg-bacon-pink">
                  CRUNCHING...
                </div>
              </div>
            </div>
      ...
      <section className="py-24 px-6 bg-bacon-bg">
        <div className="max-w-4xl mx-auto text-center">
          <span className="font-bold uppercase tracking-widest text-sm text-bacon-orange">The Struggle is Real</span>
          <h2 className="text-4xl md:text-5xl font-extrabold mt-4 mb-12 font-heading">Stop Dealing with "The Squeal"</h2>
          <div className="grid md:grid-cols-3 gap-8 text-left">
            <div className="p-8 rounded-3xl bg-bacon-card border border-bacon-border">
      ...
      <section id="how-it-works" className="py-24 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-black font-heading">3 Steps to Efficiency.</h2>
        </div>
        <div className="grid md:grid-cols-3 gap-12 relative">
          <div className="relative">
            <div className="text-8xl font-black absolute -top-10 -left-4 text-white/[0.05]">01</div>
            <div className="relative z-10">
              <h3 className="text-3xl font-bold mb-4 text-bacon-pink">Clone</h3>
          ...
          <div className="relative">
            <div className="text-8xl font-black absolute -top-10 -left-4 text-white/[0.05]">02</div>
            <div className="relative z-10">
          ...
          <div className="relative">
            <div className="text-8xl font-black absolute -top-10 -left-4 text-white/[0.05]">03</div>
            <div className="relative z-10">
              <h3 className="text-3xl font-bold mb-4 text-bacon-orange">Crunch</h3>
      ...
      {/* Use Cases */}
      <section id="features" className="py-24 px-6 bg-bacon-bg">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1">
            <h2 className="text-4xl md:text-5xl font-black mb-8 font-heading">
              Built for the <br /><span className="text-bacon-pink">Modern Creator.</span>
            </h2>
            <ul className="space-y-6 list-none p-0">
              <li className="flex items-start space-x-4">
                <span className="p-1 rounded bg-bacon-pink/20 text-bacon-pink">{'\u2713'}</span>
                <div>
      ...
      <section id="pricing" className="py-24 px-6 max-w-5xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black font-heading">Simple, Tasty Pricing.</h2>
        </div>
        <div className="grid md:grid-cols-2 gap-8">
          {/* Creator Tier */}
          <div className="p-10 flex flex-col bg-bacon-card border border-bacon-border rounded-[2rem]">
            <div className="mb-8">
            ...
            <button className="w-full border-2 border-gray-700 py-4 rounded-xl font-bold hover:bg-white hover:text-black transition cursor-pointer bg-transparent text-white">Get Started</button>
          </div>
          {/* Pro Tier */}
          <div className="p-10 flex flex-col relative overflow-hidden rounded-[2rem] border-2 border-bacon-pink" style={{ background: 'linear-gradient(to bottom right, #262626, #171717)' }}>
            <div className="absolute top-4 right-4 text-white text-xs px-3 py-1 rounded-full font-bold bg-bacon-pink">MOST POPULAR</div>
            <div className="mb-8">
              <h3 className="text-2xl font-bold mb-2 text-bacon-pink">Pro</h3>
            ...
            <button
              className="w-full text-white py-4 rounded-xl font-black uppercase tracking-widest bg-bacon-pink border-none cursor-pointer transition-all hover:shadow-[0_0_20px_rgba(255,30,86,0.4)] hover:-translate-y-0.5"
            >
              Go Pro Now
            </button>
          </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto p-12 md:p-20 text-center shadow-2xl relative overflow-hidden rounded-[3rem]" style={{ background: 'linear-gradient(to right, #FF1E56, #FFAC41)' }}>
          <div className="absolute -bottom-10 -right-10 opacity-20 rotate-12 text-[10rem]">{'\uD83E\uDD53'}</div>
          <h2 className="text-4xl md:text-6xl font-black text-white mb-8 font-heading">
          ...
          <div className="inline-block p-2 rounded-2xl bg-black/20">
            <Link
              to="/app"
              className="inline-block px-12 py-5 rounded-xl font-black text-xl shadow-lg bg-white text-black no-underline transition-colors hover:bg-gray-100"
            >
              CREATE FREE ACCOUNT
            </Link>
          </div>
